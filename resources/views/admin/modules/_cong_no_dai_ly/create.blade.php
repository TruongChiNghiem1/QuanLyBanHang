            ...
            <div class="white_card_header">
                <div class="box_header m-0">
                    <div class="main-title">
                        <h3 class="m-0">Thêm công nợ đại lý</h3>
                    </div>
                </div>
            </div>
            <div class="white_card_body">
                <div class="card-body">
                    <form action="{{ route('admin._cong_no_dai_ly.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-lg-12">
                                <label class="form-label" for="inputAddress">Chọn nhà cung cấp</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="inputAddress">Đợt</label>
