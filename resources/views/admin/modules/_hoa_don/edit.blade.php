...
@section('content')
    <form action="{{ route('admin._hoa_don.store') }}" method="post" enctype="multipart/form-data">
        <div class="row mb-3">
            <div class="col-lg-9">
            ...
            <div class="col-lg-3">
                <div class="white_card card_height_100 mb_30 ">
                    ...
                    <div class="white_card_body typography">
                        ...
                        <button type="submit" class="btn btn-primary color_background">Thêm hóa đơn & in</button>
                    </div>
                </div>
            </div>
        </div>
