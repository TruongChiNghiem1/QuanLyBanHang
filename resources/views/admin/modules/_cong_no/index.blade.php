                            ...
                            <tbody>
                                ...
                                @foreach ($congNo as $cn)
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ route('admin._cong_no.show', ['id' => $cn->MaKH]) }}">{{ $cn->TenKhachHang }}</a>
                                        </td>
                                        <td>{{ $cn->Vu }}</td>
                                        ...
                                        <td><a href="{{ route('admin._cong_no.edit', ['id' => $cn->MaCongNo]) }}">Sửa</a>
                                        </td>
                                        <td><a style='color: red;'
                                                href="{{ route('admin._cong_no.destroy', ['id' => $cn->MaCongNo]) }}" onclick="return confirm('Bạn có muốn xóa công nợ này?');">Xóa</a>
                                        </td>
                                    </tr>
                                    @php
                                        $i++;
