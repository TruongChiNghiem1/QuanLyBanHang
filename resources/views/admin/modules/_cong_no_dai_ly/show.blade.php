        ...
        <div class="card_box box_shadow position-relative mb_30     ">
            <div class="white_box_tittle     ">
                <div class="main-title2 ">
                    <h4 class="mb-2 nowrap ">Tên nhà cung cấp: {{ $khachHang->TenKhachHang }}</h4>
                </div>
            </div>
            <div class="box_body">
                    ...
                    <div class="white_box_tittle list_header">
                        ...
                        <div class="box_right d-flex lms_block">
                            ...
                            <div class="add_button ms-2">
                                <a href="{{ route('admin._cong_no_dai_ly.create') }}" class="btn_1">Thêm công nợ đại lý</a>
                            </div>
                        </div>
                    </div>
                                ...
                                @if ($congNo != null)
                                    @foreach ($congNo as $cn)
                                        <tr>
                                            ...
                                            <td>{{ $cn->NgayKetThuc == NULL ? 'Now' : date('d/m/Y', strtotime($cn->NgayKetThuc)) }}</td>
                                            <td><a
